...
class Jacinto_detseg_noup(nn.Module):
    def __init__(self, num_classes_seg, num_classes_OD, num_classes_lane, pretrained=None, mode = "detection"):
        ...
        self.classificationModel = ClassificationModel(64, num_anchors = 15, num_classes= self.num_classes_OD)
