...
class Jacinto_enhance_one_channel_v1(nn.Module):
    def __init__(self, in_depth, num_classes, input_size, phase = 'train'):
        super(Jacinto_enhance_one_channel_v1, self).__init__()
        ...
        self.ctx_conv1 = self._make_conv_block(64, 64, 3, 1, 1, 1, 1) #8x
        self.ctx_conv2 = self._make_conv_block(64, 64, 3, 1, 4, 4, 1) #8x
        self.ctx_conv3 = self._make_conv_block(64, 64, 3, 1, 4, 4, 1) #8x
        self.ctx_conv4 = self._make_conv_block(64, 64, 3, 1, 4, 4, 1) #8x
...
class Jacinto_enhance_one_channel_v2(nn.Module):
    def __init__(self, in_depth, num_classes, input_size, phase = 'train'):
        super(Jacinto_enhance_one_channel_v2, self).__init__()
        self.in_depth = in_depth
        self.num_class = num_classes
        self.input_size = input_size
        self.phase = phase
        ...
        # enhance ####
        ##############
        self.ctx_conv_up1 = self._make_conv_block(128, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up2 = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up3 = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
    ...
    def forward(self, x):
        x = self.conv1a(x) #256
        x = self.conv1b(x) #128
        x = self.poolind2d(x)#64
        x = self.res2a_branch2a(x) 
        out2 = self.res2a_branch2b(x)
        x = self.poolind2d(out2) #32
        x = self.res3a_branch2a(x) 
        x = self.res3a_branch2b(x)
        out3a_ = self.out3a(x)
        x = self.poolind2d(x) #16
...
class Jacinto_enhance_one_channel_remove_sum(nn.Module):
    def __init__(self, in_depth, num_classes, input_size, phase = 'train'):
        super(Jacinto_enhance_one_channel_remove_sum, self).__init__()
        self.in_depth = in_depth
        self.num_class = num_classes
        self.input_size = input_size
        self.phase = phase
        ...
        self.out3a = self._make_conv_block(64, 64, 3, 1, 1, 1, 2) 
        self.out5a = self._make_conv_block(512, 64, 3, 1, 4, 4, 2)   
