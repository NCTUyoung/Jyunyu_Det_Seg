...
class Jacinto_pretrain(nn.Module):
    # def __init__(self, num_classes = 8):
    # def __init__(self, num_classes, input_size, phase = 'train'):
    def __init__(self, in_depth, num_classes, input_size, phase = 'train'):
        super(Jacinto_pretrain, self).__init__()
        ...
        self.ctx_final_ = nn.Sequential(nn.Conv2d(64, self.num_class, 3, 1, 1, 1 ,1),
                            nn.ReLU())
        # self.ctx_final = self._make_conv_block(64, self.num_class, 3, 1, 2, 2, 1)
...
class Jacinto_pretrain_enhance(nn.Module):
    # def __init__(self, num_classes = 8):
    # def __init__(self, num_classes, input_size, phase = 'train'):
    def __init__(self, in_depth, num_classes, input_size, phase = 'train'):
        super(Jacinto_pretrain_enhance, self).__init__()
        self.num_class = num_classes
        self.input_size = input_size
        # self.phase = phase
        ...
        self.ctx_final_ = nn.Sequential(nn.Conv2d(64, self.num_class, 3, 1, 1, 1 ,1),
                            nn.ReLU())
        # self.ctx_final_ = nn.Conv2d(64, self.num_class, 3, 1, 1, 1 ,1),
        ##############
        # enhance ####
        ##############
