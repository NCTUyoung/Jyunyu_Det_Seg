...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes_seg, num_classes_OD, block, layers, mode = "detection"):
        ...
        # self.D2_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D2_conv_3x3_2 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D2_conv_3x3_3 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D3_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D3_conv_3x3_2 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D3_conv_3x3_3 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D4_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D4_conv_3x3_2 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 1)
        # self.D4_conv_3x3_3 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 1)
        # self.D5_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 1)
        # self.D5_conv_3x3_2 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 1)
        # self.D5_conv_3x3_3 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 1)

        self.D2_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D2_conv_3x3_2 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D2_conv_3x3_3 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D3_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D3_conv_3x3_2 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D3_conv_3x3_3 = nn.Conv2d(128, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D4_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D4_conv_3x3_2 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D4_conv_3x3_3 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D5_conv_3x3_1 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D5_conv_3x3_2 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        self.D5_conv_3x3_3 = nn.Conv2d(128 ,128, kernel_size = 3, stride = 1, padding = 4, dilation = 4)
        ...
        self.conv_final_smooth = nn.Conv2d(512, 256, kernel_size = 3, stride = 1, padding = 1)
        self.conv_final_smooth2 = nn.Conv2d(256, 128, kernel_size = 3, stride = 1, padding = 1)
    ...
    def forward(self, inputs):
        if self.mode == "detection":
            ...
            d_smooth = F.relu(self.conv_final_smooth2(d_smooth))
            ##################################
