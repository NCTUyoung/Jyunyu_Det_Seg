...
class Jacinto_detseg_lane_v5(nn.Module):
    def __init__(self, num_classes_seg, num_classes_OD, num_classes_lane, pretrained=None, input_shape = [512,1024], mode = "detection"):
        ...
        self.ctx_conv_up1_3_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up1_4_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up1_5_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up1_6_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up1_7_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up1_8_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up1_9_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up1_10_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        ...
        self.ctx_conv_up2_3_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up2_4_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up2_5_lane = self._make_conv_block(64, 64, 3, 1, 4, 4, 1)
        self.ctx_conv_up2_6_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up2_7_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up2_8_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up2_9_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
        self.ctx_conv_up2_10_lane = self._make_conv_block(64, 64, 3, 1, 1, 1, 1)
    ...
    def forward_lane(self, inputs):
        ...
        x = self.ctx_conv_up1_6_lane(x)
        x = self.ctx_conv_up1_7_lane(x)
        x = self.ctx_conv_up1_8_lane(x)
        x = self.ctx_conv_up1_9_lane(x)
        x = self.ctx_conv_up1_10_lane(x)
        ...
        x = self.ctx_conv_up2_6_lane(x)
        x = self.ctx_conv_up2_7_lane(x)
        x = self.ctx_conv_up2_8_lane(x)
        x = self.ctx_conv_up2_9_lane(x)
        x = self.ctx_conv_up2_10_lane(x)
